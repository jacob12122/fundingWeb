	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				登陆账户：<security:authentication property="principal.originalAdmin.loginAcct"/><br/>
				登陆密码：<security:authentication property="principal.originalAdmin.userPswd"/><br/>
				用户名：<security:authentication property="principal.originalAdmin.userName"/><br/>
				用户邮箱：<security:authentication property="principal.originalAdmin.email"/><br/>
				创建时间：<security:authentication property="principal.originalAdmin.createTime"/><br/>
