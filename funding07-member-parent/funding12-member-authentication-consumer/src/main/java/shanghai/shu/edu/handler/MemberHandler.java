...
import shanghai.shu.edu.api.RedisRemoteService;
import shanghai.shu.edu.config.ShortMessageProperties;
import shanghai.shu.edu.constant.CrowdConstant;
import shanghai.shu.edu.entity.po.Member;
import shanghai.shu.edu.entity.vo.MemberLoginVO;
import shanghai.shu.edu.entity.vo.MemberVO;
...
public class MemberHandler {
    ...
    public String login(
        ...
        ResultEntity<Member> resultEntity =
                mySQLRemoteService.getMemberByLoginAcctRemote(loginacct);
        ...
        Member memberPO = resultEntity.getData();
